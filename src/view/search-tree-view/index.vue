<template>
    <div class="template-search-tree">
        ...
        <div class="container">
            <search-tree ref="searchTree" @select="handleSelect" :currentNodeKey="currentNodeKey" :treeData="treeData" clearable></search-tree>
        </div>
...
<script>
import SearchTree from '../../components/SearchTree/SearchTree.vue'
